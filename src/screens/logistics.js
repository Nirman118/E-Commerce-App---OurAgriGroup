...
class Logistics extends Component {
    constructor(props) {
        ...
        this.ref= firestore().collection('logistics')
    ...
    async getInfo(querySnapshot){
        ...
        if(querySnapshot){
          querySnapshot.forEach(async(doc) => {
            const{ email,  village, Firstname,Lastname, age, phoneno, state, city, Vehicleno,pincode} = doc.data();
            info.push({
              key: doc.id,
              firstname: Firstname,
              lastname:Lastname,
    ...
    render() {
        const renderItem = (item) => {
            ...
            return (
                ...
                <Text style={styles.billtxt} >Vehicle no:{k.Vehicleno}</Text>
        ...
        return (
            <View style={{ justifyContent: "center", alignItems: "center", flex: 1 }}>
                <ImageBackground source={require('../assets/screen2.png')} style={styles.screen2} >
                    ...
                    <Text style={{ fontWeight: "bold", fontSize: 26, textAlign: "center" }}>Logistics Provider</Text>
