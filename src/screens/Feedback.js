...
class Feedback extends Component {
    ...
    render() {
        console.log("hhd",this.state.data)
        const sub = () => {
            firestore()
            .collection('feedback')
            .add({
        ...
        return (
            ...
            <View style={{justifyContent:"center", alignItems:"center"}}>            
                <Text style={{fontSize:20, fontWeight:"bold", top:"10%", color:"black"}}>Your Feedback:</Text>
                <TextInput style={{height:hp("30%"), width:wp("90%"), borderWidth:1, top:"20%", borderColor:"black", backgroundColor:"white",justifyContent:"flex-start",  color:"black", textAlign:"left"}} value={this.state.feedback}
              onChangeText={(v) => this.setState({ feedback: v })}></TextInput>
                <TouchableOpacity onPress={()=> sub()} style={{height:hp("6%"), width:wp("30%"),borderWidth:1, top:"80%", borderColor:"black", backgroundColor:"black", padding:10}}>
                    <Text style={{  color:"white",textAlign:"center", fontWeight:"bold", fontSize:20}}>SUBMIT</Text>
                </TouchableOpacity>
                </View>
                </ImageBackground>
            </View>
