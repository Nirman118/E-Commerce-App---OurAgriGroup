...
class Cart extends Component {
    ...
    async componentDidMount() {
        ...
        if(JSON.parse(types) == 'user'){
            ...
            let bag = await AsyncStorage.getItem('MyBags')
            if(bag && bag.length > 0){
               this.setState({data: JSON.parse(bag)}) 
            }
            ...
            <View >
                <ImageBackground source={require('../assets/screen2.png')} style={styles.screen2} >
                    <View style={{ flexDirection: "row" }}>
                        ...
                        <Text style={{ fontSize: 25, fontWeight: "bold", margin: 10 }}>Your Cart</Text>
                        <TouchableOpacity>
                            <Text></Text>
                        </TouchableOpacity>
                    </View>
                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) => {
                                ...
                                return <View style={{ flex: 1 }}>
                                    <View style={{ flexDirection: "row", borderRadius: 10, margin: 20, backgroundColor: "white",flex:1, height:100}}>
                    ...
                    {this.state.type == 'user' ? <View style={{ bottom: 10, marginTop: 20 }}>
                        ...
                        onPress={()=> this.props.navigation.navigate('Bill', {total:total})}>
