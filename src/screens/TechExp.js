...
class TechExp extends Component {
    constructor(props) {
        super(props);
        this.state = {
            user: '',
        ...
        this.ref= firestore().collection('techexp')
    ...
    async getInfo(querySnapshot){
        ...
        if(querySnapshot){
          querySnapshot.forEach(async(doc) => {
            const{ email,  village, Firstname,Lastname, age, phoneno, state, city,pincode, institution,exp, profession} = doc.data();
            info.push({
              key: doc.id,
              firstname: Firstname,
              lastname:Lastname,
    ...
    render() {
        const renderItem = (item) => {
            ...
            return (
                <View style={{  flex:0.6, backgroundColor: "white" , margin:10, borderRadius:20,paddingBottom:10}}>
                ...
                <Text style={styles.billtxt} >Institution: { k.institution}</Text>
                <Text style={styles.billtxt} >Experience: { k.exp}</Text>
                <Text style={styles.billtxt} >profession: { k.profession}</Text>
                </View>
            )
        }
        ...
        return (
            <View style={{ justifyContent: "center", alignItems: "center", flex:1 }}>
                <ImageBackground source={require('../assets/screen2.png')} style={styles.screen2} >
                    ...
                    <Text style={{ fontWeight: "bold", fontSize: 26, textAlign: "center" }}>Technical Expert</Text>
